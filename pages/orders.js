        ...
        <>
            ...
            >
                <Container maxWidth="lg">
                                ...
                                >
                                    {editingOrderId === order.id ? (
                                        ...
                                        <Box>
                                            ...
                                            <Typography sx={{ fontSize: "1.1rem" }}>
                                                <strong>Pending Qty:</strong> {order.original_qty - order.executed_qty}
                                            </Typography>
                                            <Box sx={{ mt: 2, display: "flex", gap: 2, flexWrap: "wrap" }}>
                                                {/* Amend and Cancel buttons */}
                                                ...
                                                {/* Add Execute button for pending/partial orders */}
                                                {order.status !== "executed" && order.status !== "cancelled" && (
                                                    <Button
                                                        variant="outlined"
                                                        color="secondary"
                    ...
                    <Dialog open={Boolean(executingOrderId)} onClose={() => setExecutingOrderId(null)}>
